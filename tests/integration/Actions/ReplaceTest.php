 ...
 *
 * @since 1.0.0
 * @covers \WpConvertToWebp\Actions\Replace
 */
class ReplaceTest extends IntegrationTestCase {
	...
	public function set_up(): void {
		...
		if ( ! file_exists( $webp_path ) ) {
			$converter = \WpConvertToWebp\Utils\Converter::get_instance();
	...
	public function test_replaces_img_in_content(): void {
		...
		$replace_mode = get_option( 'convert_to_webp_replace_mode', 0 );
	...
	public function test_respects_replace_mode_setting(): void {
		...
		update_option( 'convert_to_webp_replace_mode', 1 );
