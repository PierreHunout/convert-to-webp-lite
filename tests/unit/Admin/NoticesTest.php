...
use PoetryConvertToWebp\Admin\Notices;
...
class NoticesTest extends TestCase {
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Admin\Notices::__clone
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Admin\Notices::__wakeup
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Admin\Notices::get_instance
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Admin\Notices::init
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Admin\Notices::display_notices
	 * @return void
	 */
	...
	public function test_display_notices_returns_early_when_user_lacks_capability(): void {
		$_GET['page'] = 'poetry-convert-to-webp';
	...
	public function test_display_notices_returns_early_when_nonce_fails_for_no_files(): void {
		...
		BrainMonkey\expect( 'wp_verify_nonce' )
			->once()
			->with( 'invalid-nonce', 'poetry_convert_to_webp_notice' )
			->andReturn( false );
	...
	public function test_display_notices_shows_no_files_notice(): void {
		...
		BrainMonkey\expect( 'wp_verify_nonce' )
			->once()
			->with( 'valid-nonce', 'poetry_convert_to_webp_notice' )
			->andReturn( true );

		BrainMonkey\expect( 'esc_html__' )
			->once()
			->with( 'No files found to process.', 'poetry-convert-to-webp' )
		...
		$this->assertStringContainsString( 'poetry-convert-to-webp__notice--nofiles', $output );
	...
	public function test_display_notices_shows_deletion_notice_with_data(): void {
		...
		BrainMonkey\expect( 'get_transient' )
			->once()
			->with( 'poetry_convert_to_webp_deletion_data' )
		...
		$this->assertStringContainsString( 'poetry-convert-to-webp__notice--deletion', $output );
		...
		$this->assertStringContainsString( 'poetry-convert-to-webp__message--success', $output );
	}
	...
	public function test_display_notices_handles_empty_deletion_data(): void {
		...
		BrainMonkey\expect( 'esc_html__' )
			->once()
			->with( 'Deleted WebP files', 'poetry-convert-to-webp' )
	...
	public function test_display_notices_formats_multiple_messages_correctly(): void {
		...
		$this->assertStringContainsString( 'poetry-convert-to-webp__message--success', $output );
		$this->assertStringContainsString( 'poetry-convert-to-webp__message--error', $output );
		$this->assertStringContainsString( 'poetry-convert-to-webp__message--critical', $output );
	}
	...
	public function test_display_notices_sanitizes_html_classes(): void {
		...
		$this->assertStringContainsString( 'poetry-convert-to-webp__message--success-class', $output );
	}
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Admin\Notices
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Admin\Notices::__construct
	 * @covers \PoetryConvertToWebp\Admin\Notices::init
	 * @return void
	 */
