...
class HelpersTest extends TestCase {
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::__construct
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::__clone
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::__wakeup
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::get_message
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::get_basedir
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::get_attachments
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::get_attachment_id_from_url
	 * @return void
	 */
	...
	public function test_get_attachment_id_from_url_returns_cached_result(): void {
		...
		BrainMonkey\expect( 'wp_cache_get' )
			->once()
			->with( 'poetry_convert_to_webp_attachment_id_' . md5( $url ), 'poetry_convert_to_webp' )
			->andReturn( 123 );
	...
	public function test_get_attachment_id_from_url_uses_attachment_url_to_postid(): void {
		...
		BrainMonkey\expect( 'wp_cache_set' )
			->once()
			->with( 'poetry_convert_to_webp_attachment_id_' . md5( $url ), 456, 'poetry_convert_to_webp', 3600 );
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::clear_attachment_cache
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::parse_srcset
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::get_srcset
	 * @return void
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @covers \PoetryConvertToWebp\Utils\Helpers::attachment_is_webp
	 * @return void
	 */
